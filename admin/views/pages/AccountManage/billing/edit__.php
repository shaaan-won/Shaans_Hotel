...
// 	echo Form::input(["label"=>"Check In Date","type"=>"text","name"=>"check_in_date","value"=>"$billing->check_in_date"]);
// 	echo Form::input(["label"=>"Check Out Date","type"=>"text","name"=>"check_out_date","value"=>"$billing->check_out_date"]);
...
// 	echo Form::input(["label"=>"Other Services","type"=>"text","name"=>"other_services","value"=>"$billing->other_services"]);
// 	echo Form::input(["label"=>"Other Charges","type"=>"text","name"=>"other_charges","value"=>"$billing->other_charges"]);
...
<div class="container">
	<div class="invoice-header">
		...
		<p>Invoice #<span id="invoice-id"><?php echo $billing->id ?></span></p>
		<p>Date: <span id="invoice-date"><?php echo $billing->created_at ?></span></p>
	</div>
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<p>Check-In Date: <span id="check-in"><?php echo $billing->check_in_date ?></span></p>
			<p>Check-Out Date: <span id="check-out"><?php echo $billing->check_out_date ?></span></p>
	...
	<table class="table table-bordered invoice-table">
		...
		<tbody>
			...
			<tr>
				...
				<td id="extra-services">$<?php echo $billing-> extra_services ?></td>
			</tr>
			<tr>
